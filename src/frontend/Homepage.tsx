...
export function Homepage({ locale, adminPath = '/admin' }: HomepageProps) {
  return (
    <Layout title="CF ShortURL" lang={locale}>
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-4xl mx-auto px-6 py-20 text-center">
          ...
          <div className="flex gap-3 justify-center flex-wrap mb-16">
            <a href={adminPath} className="inline-flex items-center gap-1.5 px-5 py-2.5 bg-gray-900 text-white rounded-lg text-sm font-semibold hover:bg-gray-800 no-underline transition-colors">
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
              {t(locale, 'homepage.adminPanel')}
            </a>
